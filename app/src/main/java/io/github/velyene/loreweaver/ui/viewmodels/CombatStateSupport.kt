...
internal fun CombatUiState.advanceTurn(combatTextProvider: CombatTextProvider): CombatUiState {
	...
	return copy(
		...
		activeStatuses = activeStatuses + expiredMessages + combatTextProvider.roundBeginsStatus(currentRound + 1)
	)
}

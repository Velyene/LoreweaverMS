...
internal object EquipmentReferenceGearData {
	private val gearBodies = linkedMapOf(
		...
		"Alchemistâ€™s Fire" to "When you take the Attack action, you can replace one of your attacks with throwing a flask of Alchemistâ€™s Fire.",
		...
		"Healerâ€™s Kit" to "A Healerâ€™s Kit contains bandages, salves, and splints. As a Utilize action, you can expend one use to stabilize an Unconscious creature.",
	...
	private val ADVENTURING_GEAR_ROWS = listOf(
		...
		listOf("Alchemistâ€™s Fire", "1 lb.", "50 GP"),
		listOf("Ammunition", "Varies", "Varies"),
		listOf("Antitoxin", "â€”", "50 GP"),
		...
		listOf("Magnifying Glass", "â€”", "100 GP"),
		...
		listOf("Scholarâ€™s Pack", "22 lb.", "40 GP"),
		listOf("Shovel", "5 lb.", "2 GP"),
		listOf("Signal Whistle", "â€”", "5 CP"),
		listOf("Spell Scroll", "â€”", "Varies"),
		listOf("Spikes, Iron", "5 lb.", "1 GP"),
		listOf("Spyglass", "1 lb.", "1,000 GP"),
		listOf("String", "â€”", "1 SP"),

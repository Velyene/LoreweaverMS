...
/*
 * FILE: EquipmentReferenceMagicItemsData.kt
 *
 * TABLE OF CONTENTS:
 * 1. Shared helper constants and entry builders
 * 2. Detailed magic-item entries keyed by approved SRD names
 * 3. Placeholder-backed A-to-Z fallback entries
 * 4. Public assembled magic-item dataset
 */

package io.github.velyene.loreweaver.domain.util

internal object EquipmentReferenceMagicItemsData {
	private const val WONDROUS_ITEM_RARE = "Wondrous Item, Rare"
	private const val POTIONS_OF_HEALING = "Potions of Healing"
	...
	private fun detailedMagicItem(
		name: String,
		subtitle: String,
		body: String,
		vararg tables: ReferenceTable
	): Pair<String, MagicItemReferenceEntry> =
		name to magicItem(name = name, subtitle = subtitle, body = body, *tables)

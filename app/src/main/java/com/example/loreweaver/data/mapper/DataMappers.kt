...
package com.example.loreweaver.data.mapper
...
import com.example.loreweaver.domain.model.EncounterStatus
...
fun com.example.loreweaver.data.entities.NoteEntity.toDomain(): Note {
	return when (subtype) {
		"Lore" -> Note.Lore(
			id = id,
			campaignId = campaignId,
...
fun Note.toEntity(): com.example.loreweaver.data.entities.NoteEntity {
	return when (this) {
		is Note.General -> com.example.loreweaver.data.entities.NoteEntity(
			id = id,
			campaignId = campaignId ?: "",
			subtype = "General",
			content = content,
		...
		is Note.Lore -> com.example.loreweaver.data.entities.NoteEntity(
			id = id,
			campaignId = campaignId ?: "",
			subtype = "Lore",
			content = content,
		...
		is Note.NPC -> com.example.loreweaver.data.entities.NoteEntity(
			id = id,
			campaignId = campaignId ?: "",
			subtype = "NPC",
			content = content,
		...
		is Note.Location -> com.example.loreweaver.data.entities.NoteEntity(
			id = id,
			campaignId = campaignId ?: "",
			subtype = "Location",
			content = content,

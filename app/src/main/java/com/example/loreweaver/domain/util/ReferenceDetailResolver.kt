	...
	private fun resolveAmmunition(slug: String): ReferenceDetailContent? {
		...
		return ReferenceDetailContent(
			...
			statRows = listOf(
				...
				"Weight" to ammunition.weight,
				"Cost" to ammunition.cost
			)
		)
	}

...
import com.example.loreweaver.domain.util.AbilityScoreSummary
import com.example.loreweaver.domain.util.BackgroundReference
import com.example.loreweaver.domain.util.CharacterCreationReference
import com.example.loreweaver.domain.util.CharacterCreationStep
import com.example.loreweaver.domain.util.CharacterCreationTextSection
import com.example.loreweaver.domain.util.FeatReference
import com.example.loreweaver.domain.util.LanguageReference
import com.example.loreweaver.domain.util.RaceReference
import com.example.loreweaver.domain.util.RacialTraitReference
...
import com.example.loreweaver.domain.util.SubraceReference
...
private data class CharacterCreationContentState(
	...
	val visibleTools: List<com.example.loreweaver.domain.util.ToolReferenceEntry>,
	val visibleWeapons: List<com.example.loreweaver.domain.util.WeaponReferenceEntry>,
	val visibleArmor: List<com.example.loreweaver.domain.util.ArmorReferenceEntry>,
	val visibleGear: List<com.example.loreweaver.domain.util.AdventuringGearEntry>,
	val visibleMagicItems: List<com.example.loreweaver.domain.util.MagicItemReferenceEntry>,
	val visibleAmmunition: List<com.example.loreweaver.domain.util.AmmunitionReferenceEntry>,
	val visibleFocuses: List<com.example.loreweaver.domain.util.FocusReferenceEntry>,
	val visibleMounts: List<com.example.loreweaver.domain.util.MountReferenceEntry>,
	val visibleTackAndDrawn: List<com.example.loreweaver.domain.util.TackDrawnReferenceEntry>,
	val visibleLargeVehicles: List<com.example.loreweaver.domain.util.LargeVehicleReferenceEntry>,
...
private fun rememberCharacterCreationContentState(
	...
	val equipmentChapterSections = remember(normalizedQuery) {
		com.example.loreweaver.domain.util.EquipmentReference.CHAPTER_SECTIONS.filter {
			it.matchesQuery(normalizedQuery)
		}
	}
	val weaponPropertySections = remember(normalizedQuery) {
		com.example.loreweaver.domain.util.EquipmentReference.WEAPON_PROPERTY_SECTIONS.filter {
			it.matchesQuery(normalizedQuery)
		}
	}
	val weaponMasterySections = remember(normalizedQuery) {
		com.example.loreweaver.domain.util.EquipmentReference.WEAPON_MASTERY_SECTIONS.filter {
			it.matchesQuery(normalizedQuery)
		}
	}
	val adventuringGearDetailSections = remember(normalizedQuery) {
		com.example.loreweaver.domain.util.EquipmentReference.ADVENTURING_GEAR_DETAIL_SECTIONS.filter {
			it.matchesQuery(normalizedQuery)
		}
	}

...
import com.example.encountertimer.ui.theme.ObsidianBlack
import com.example.encountertimer.ui.theme.PanelSurface
import com.example.encountertimer.ui.util.NOTE_TYPES
import com.example.encountertimer.ui.util.NOTE_TYPE_GENERAL
...
import com.example.encountertimer.ui.util.buildNpcExtra
...
private data class CampaignDetailContentState(
	val campaign: com.example.encountertimer.domain.model.Campaign?,
	val selectedTab: Int,
...
private data class CampaignDetailActions(
	...
	val onAddEncounterWithMonsters: (String, List<com.example.encountertimer.domain.model.RemoteItem>) -> Unit
)
...
fun LinkedEncounterList(
	...
	onAddEncounterWithMonsters: (String, List<com.example.encountertimer.domain.model.RemoteItem>) -> Unit
) {

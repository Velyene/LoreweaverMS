...
import com.example.encountertimer.domain.util.AdventuringGearEntry
import com.example.encountertimer.domain.util.AmmunitionReferenceEntry
import com.example.encountertimer.domain.util.ArmorReferenceEntry
...
import com.example.encountertimer.domain.util.FocusReferenceEntry
import com.example.encountertimer.domain.util.LargeVehicleReferenceEntry
import com.example.encountertimer.domain.util.MagicItemReferenceEntry
import com.example.encountertimer.domain.util.MountReferenceEntry
...
import com.example.encountertimer.domain.util.TackDrawnReferenceEntry
import com.example.encountertimer.domain.util.ToolReferenceEntry
import com.example.encountertimer.domain.util.WeaponReferenceEntry
...
private fun ToolReferenceCard(tool: ToolReferenceEntry, onClick: () -> Unit) {
	Card(
		...
		Column(
			...
			StackedDetailRow("Weight", tool.weight)
			StackedDetailRow("Cost", tool.cost)
...
private fun WeaponReferenceCard(weapon: WeaponReferenceEntry, onClick: () -> Unit) {
	Card(
		...
		Column(
			...
			StackedDetailRow("Weight", weapon.weight)
			StackedDetailRow("Cost", weapon.cost)
...
private fun ArmorReferenceCard(armor: ArmorReferenceEntry, onClick: () -> Unit) {
	Card(
		...
		Column(
			...
			StackedDetailRow("Weight", armor.weight)
			StackedDetailRow("Cost", armor.cost)
		}
	}
}
...
private fun AdventuringGearReferenceCard(gear: AdventuringGearEntry, onClick: () -> Unit) {
	Card(
		...
		Column(
			...
			StackedDetailRow("Weight", gear.weight)
			StackedDetailRow("Cost", gear.cost)
			gear.body?.let { body ->
...
private fun AmmunitionReferenceCard(ammunition: AmmunitionReferenceEntry, onClick: () -> Unit) {
	Card(
		...
		Column(
			...
			StackedDetailRow("Weight", ammunition.weight)
			StackedDetailRow("Cost", ammunition.cost)
		}
	}
}
...
private fun FocusReferenceCard(focus: FocusReferenceEntry, onClick: () -> Unit) {
	Card(
		...
		Column(
			...
			StackedDetailRow("Weight", focus.weight)
			StackedDetailRow("Cost", focus.cost)
...
private fun MountReferenceCard(mount: MountReferenceEntry, onClick: () -> Unit) {
	Card(
		...
		Column(
			...
			StackedDetailRow("Cost", mount.cost)
		}
	}
}
...
private fun TackDrawnReferenceCard(item: TackDrawnReferenceEntry, onClick: () -> Unit) {
	Card(
		...
		Column(
			...
			StackedDetailRow("Weight", item.weight)
			StackedDetailRow("Cost", item.cost)
		}
	}
}
...
private fun LargeVehicleReferenceCard(vehicle: LargeVehicleReferenceEntry, onClick: () -> Unit) {
	Card(
		...
		Column(
			...
			StackedDetailRow("Cost", vehicle.cost)
		}
	}
}

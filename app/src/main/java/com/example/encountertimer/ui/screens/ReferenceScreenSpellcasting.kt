...
import com.example.encountertimer.domain.util.AreaOfEffect
import com.example.encountertimer.domain.util.CastingTime
import com.example.encountertimer.domain.util.ReferenceTable
import com.example.encountertimer.domain.util.SchoolOfMagic
import com.example.encountertimer.domain.util.SpellComponent
import com.example.encountertimer.domain.util.SpellSlotTable
import com.example.encountertimer.domain.util.SpellcasterType
import com.example.encountertimer.domain.util.SpellcastingReference
import com.example.encountertimer.domain.util.SrdSpellIndexReference
import com.example.encountertimer.ui.viewmodels.ReferenceUiState

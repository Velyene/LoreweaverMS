...
import com.example.encountertimer.domain.model.Condition
...
import com.example.encountertimer.domain.util.EncounterDifficulty
import com.example.encountertimer.domain.util.EncounterDifficultyResult
import com.example.encountertimer.ui.screens.CombatTrackerConstants.ACTION_BUTTON_HEIGHT_DP
import com.example.encountertimer.ui.screens.CombatTrackerConstants.DEFAULT_ENEMY_HP
import com.example.encountertimer.ui.screens.CombatTrackerConstants.DEFAULT_ENEMY_INITIATIVE
import com.example.encountertimer.ui.screens.CombatTrackerConstants.HP_QUICK_ADJUSTMENTS
import com.example.encountertimer.ui.screens.CombatTrackerConstants.INITIATIVE_ROLL_MAX
import com.example.encountertimer.ui.screens.CombatTrackerConstants.INITIATIVE_ROLL_MIN
import com.example.encountertimer.ui.screens.CombatTrackerConstants.LOG_HEIGHT_DP
import com.example.encountertimer.ui.screens.CombatTrackerConstants.NOTES_HEIGHT_DP
import com.example.encountertimer.ui.screens.CombatTrackerConstants.QUICK_HP_BUTTON_HEIGHT_DP
import com.example.encountertimer.ui.screens.CombatTrackerConstants.SETUP_BUTTON_HEIGHT_DP
import com.example.encountertimer.ui.viewmodels.CombatViewModel
	...
	Row(
		...
		HP_QUICK_ADJUSTMENTS.forEach { delta ->
			OutlinedButton(
				...
				modifier = Modifier.weight(1f).height(QUICK_HP_BUTTON_HEIGHT_DP.dp),
...
private fun EncounterActionButtons(
	...
	Row(
		...
		Button(
			onClick = onNextTurn,
			modifier = Modifier.weight(1f).height(ACTION_BUTTON_HEIGHT_DP.dp),
			colors = ButtonDefaults.buttonColors(containerColor = MaterialTheme.colorScheme.primary)
		) {
			Text(

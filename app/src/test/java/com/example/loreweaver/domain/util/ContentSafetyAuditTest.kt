...
class ContentSafetyAuditTest {
	...
	private val reviewedLongProseFiles = mapOf(
		...
		"java/com/example/loreweaver/domain/util/EncounterDifficulty.kt" to ReviewedProseFile(
		...
		"java/com/example/loreweaver/domain/util/CharacterCreationReference.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-18",
		...
		"java/com/example/loreweaver/domain/util/DiseaseReference.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-18",
		...
		"java/com/example/loreweaver/domain/util/PoisonReference.kt" to ReviewedProseFile(
		...
		"java/com/example/loreweaver/domain/util/TrapReference.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-20",
		...
		"java/com/example/loreweaver/domain/util/CoreRulesReference.kt" to ReviewedProseFile(
		...
		"java/com/example/loreweaver/domain/util/EquipmentReference.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-18",
		...
		"java/com/example/loreweaver/domain/util/EquipmentReferenceGearData.kt" to ReviewedProseFile(
		...
		"java/com/example/loreweaver/domain/util/EquipmentReferenceMagicItemsData.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-21",
		...
		"java/com/example/loreweaver/domain/util/EquipmentReferenceSectionsData.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-21",
		...
		"java/com/example/loreweaver/domain/util/EquipmentReferenceSupplementalData.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-21",
		...
		"java/com/example/loreweaver/domain/util/MadnessReference.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-18",
		...
		"java/com/example/loreweaver/domain/util/ObjectStats.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-18",
		...
		"java/com/example/loreweaver/domain/util/SpellcastingReference.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-18",
	...
	private fun isHardDoNotShipFlaggedPath(relativePath: String): Boolean {
		return relativePath == "java/com/example/loreweaver/domain/util/ClassSpellListReference.kt" ||
			relativePath == "java/com/example/loreweaver/domain/util/CharacterClassReference.kt" ||
			relativePath == "java/com/example/loreweaver/domain/util/MonsterReference.kt" ||

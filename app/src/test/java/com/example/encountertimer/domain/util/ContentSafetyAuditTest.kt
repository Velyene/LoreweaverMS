...
class ContentSafetyAuditTest {
	...
	private val reviewedLongProseFiles = mapOf(
		...
		"java/com/example/encountertimer/domain/util/EncounterDifficulty.kt" to ReviewedProseFile(
		...
		"java/com/example/encountertimer/domain/util/CharacterCreationReference.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-18",
		...
		"java/com/example/encountertimer/domain/util/DiseaseReference.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-18",
		...
		"java/com/example/encountertimer/domain/util/PoisonReference.kt" to ReviewedProseFile(
		...
		"java/com/example/encountertimer/domain/util/TrapReference.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-20",
		...
		"java/com/example/encountertimer/domain/util/CoreRulesReference.kt" to ReviewedProseFile(
		...
		"java/com/example/encountertimer/domain/util/EquipmentReference.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-18",
		...
		"java/com/example/encountertimer/domain/util/EquipmentReferenceGearData.kt" to ReviewedProseFile(
		...
		"java/com/example/encountertimer/domain/util/EquipmentReferenceMagicItemsData.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-21",
		...
		"java/com/example/encountertimer/domain/util/EquipmentReferenceSectionsData.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-21",
		...
		"java/com/example/encountertimer/domain/util/EquipmentReferenceSupplementalData.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-21",
		...
		"java/com/example/encountertimer/domain/util/MadnessReference.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-18",
		...
		"java/com/example/encountertimer/domain/util/ObjectStats.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-18",
		...
		"java/com/example/encountertimer/domain/util/SpellcastingReference.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-18",
		...
		"java/com/example/encountertimer/ui/screens/GameRulesScreen.kt" to ReviewedProseFile(
			reviewedOn = "2026-04-18",
	...
	private fun findBlockedTerms(
		...
		return sourceRoot
			.walkTopDown()
			.filter { file ->
				file.isFile && (file.extension == "kt" || file.extension == "xml")
			}
			.flatMap { file ->
	...
	private fun findBlockedTermsInComments(blockedTerms: Set<String>): List<AuditFinding> {
		return sourceRoot
			.walkTopDown()
			.filter { file -> file.isFile && (file.extension == "kt" || file.extension == "xml") }
			.flatMap { file ->
				val relativePath = normalizePath(file)
				val commentText = when (file.extension) {
					"kt" -> extractKotlinComments(file.readText())
					"xml" -> extractXmlComments(file.readText())
					else -> ""
				}
		...
		return sourceRoot
			...
			.flatMap { file ->
				...
				val extractedBlocks = when (file.extension) {
					"kt" -> extractKotlinTextBlocks(text)
					"xml" -> extractXmlTextBlocks(text)
					else -> emptyList()
				}
	...
	private fun isHardDoNotShipFlaggedPath(relativePath: String): Boolean {
		return relativePath == "java/com/example/encountertimer/domain/util/ClassSpellListReference.kt" ||
				relativePath == "java/com/example/encountertimer/domain/util/CharacterClassReference.kt" ||
				relativePath == "java/com/example/encountertimer/domain/util/MonsterReference.kt" ||
